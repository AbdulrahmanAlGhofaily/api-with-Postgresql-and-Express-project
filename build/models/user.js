...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Unable to get users: ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Unable to get user: ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.query(sql, [u.firstname, u.lastname, hash])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Unable to add user: ".concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.update = function (id, u) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, hash, result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, connection.query(sql, [id, u.firstname, u.lastname, hash])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Unable to update user with id: ".concat(u.id));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        connection.release();
                        return [2 /*return*/, 'User has been deleted successfully'];
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Unable to delete user with the id of:".concat(id, ". Error type: ").concat(error_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
